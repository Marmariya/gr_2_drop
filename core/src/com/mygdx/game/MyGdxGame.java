...
import com.badlogic.gdx.math.Rectangle; //Alt + Enter
...
public class MyGdxGame extends ApplicationAdapter {
    ...
    public void render() {
        ...
        // создаем цикл для интегрирования капель - отслеживание каждой созданной капли;
        // заставляем падать ее вниз  и в случае падения в ведро или за пределы экрана мы будем ее удалять
        // при падении в ведро длобавим звук
...
//Удаление неиспользуемых в игре объектов dispose
    @Override
    public void dispose() {
        dropImage.dispose();
        bucketImage.dispose();
